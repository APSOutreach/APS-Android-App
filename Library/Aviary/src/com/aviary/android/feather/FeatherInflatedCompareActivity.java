...
public class FeatherInflatedCompareActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		iv2.setBackgroundResource(FeatherGlobal.drawables_spectrum2[FeatherGlobal.counter2]);
	...
	class BitmapWorkerTask extends AsyncTask<Integer, Void, Bitmap> {
		...
		protected Bitmap doInBackground(Integer... params) {
			data = params[0];
			return decodeSampledBitmapFromFile(getRealPathFromURI(FeatherGlobal.path2), 500, 250);
		}

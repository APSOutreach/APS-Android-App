 ...
 * http://www.aviary.com/terms (collectively, the â€œTermsâ€�) govern your use
 ...
 * (the "API"). By clicking on the â€œAcceptâ€� button, OR BY USING OR ACCESSING
 ...
 * within Licenseeâ€™s mobile or website application (â€œAppâ€�) and to access
 ...
 * or mark that primarily describes the Licensee website, and Licenseeâ€™s use
 ...
 * Licenseeâ€™s acceptance of the terms and conditions of this Agreement as
 * modified.
 * 
...
/*
import bt.aps.spectrasnapp.Globals;
import bt.aps.spectrasnapp.InflatedCompareActivity;
*/
...
public class FeatherActivity extends MonitoredActivity implements OnToolbarClickListener, OnImageDownloadListener, OnToolListener, FeatherContext,
	...
	public void onConfigurationChanged( final Configuration newConfig ) {
		...
		mOrientation = newConfig.orientation;
		//FeatherGlobal.isCompareOpen2 == false &&
		if (newConfig.orientation == 2) {
			ActivityOptions options = ActivityOptions.makeCustomAnimation(getApplicationContext(), R.anim.right_to_center, R.anim.center_to_left);
			FeatherGlobal.isCompareOpen2 = true;
			startActivity(new Intent(getApplicationContext(), FeatherInflatedCompareActivity.class), options.toBundle());
